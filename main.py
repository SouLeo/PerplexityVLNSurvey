...
if __name__ == '__main__':
  ...
  #
  # parser.add_argument('--train_file', type=str, default='./data/train.txt.corpus',
  #                     help='training data path')
  # parser.add_argument('--vocab_file', type=str, default='./data/vocabulary.txt',
  #                     help='vocabulary file path')
  # parser.add_argument('--test_file', type=str, default='./data/test.txt.corpus',
  #                     help='test file.')
  # parser.add_argument('--gram_rank', type=int, default=5,
  #                     help='e.g 2 for bigram')
  #
  # args = parser.parse_args()

  # input_sent = Alfredinput.load_Alfred()
  # input_sent = asknavinput.load_asknav()
  # input_sent = CHAIinput.load_CHAI()
  input_sent = CVDNinput.load_CVDN()
  input_sent = R2Rinput.load_R2R()
  input_sent = REVERIEinput.load_REVERIE()
  input_sent = TOUCHDOWN.load_TOUCHDOWN()
